...
export class NgxMatYearViewComponent<D> implements AfterContentInit, OnDestroy {
  ...
  _months: NgxMatCalendarCell<D>[][] | null = null;
  ...
  _focusActiveCell() {
    if (this._matCalendarBody) {
      ...
      console.error("Missing calendar body in year view.");
    }
  }
